...
export const Statistics = ({
  ...
  return (
    <dl className="bg-statistics-background flex w-full max-w-97 animate-[blurFadeIn_0.45s_ease-out_0.45s_backwards] items-center rounded-xl px-5 py-5 motion-reduce:animate-none">
      {[
